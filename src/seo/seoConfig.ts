...
export const PAGE_SEO: Record<string, PageSeoMeta> = {
  home: {
    title: 'كافيه الفيشاوي | قهوة أصيلة في قلب خان الخليلي بالقاهرة',
    description:
      'كافيه الفيشاوي في قلب خان الخليلي والجمالية بالقاهرة: قهوة بلدي على الرمل، شاي على الطريقة المصرية، وعصائر طازجة في أجواء تراثية دافئة. تصفح المنيو وتعرف على أسعارنا.',
    path: '/',
  },
  menu: {
